...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_tshirt_0030.h5")
...
class TshirtConfig(Config):
    ...
    NUM_CLASSES = 1 + 4  # Background + tshirt
...
class TshirtDataset(utils.Dataset):
    ...
    def load_tshirt(self, dataset_dir, subset):
        ...
        self.add_class("tshirt", 0, "t1")
        self.add_class("tshirt", 1, "t2")
        self.add_class("tshirt", 2, "t3")
        self.add_class("tshirt", 3, "t4")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a tshirt dataset image, delegate to parent class.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect tshirts.')
